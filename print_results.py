...
def print_results(results_dic, results_stats_dic, model, 
    ...
    # 6b. Iterate through all statistics in the results_stats_dic dictionary
    # and print out all the percentages where the key starts with 'p'
    # These typically include the accuracy for dog classifications, breed classifications, etc.
