...
def calculates_results_stats(results_dic):
    ...
    #           classified NOT-a-dog images. Recall that this can be calculated 
    #           by the number of correctly classified NOT-a-dog images ('n_correct_notdogs') 
    #           divided by the number of NOT-a-dog images ('n_notdogs_img'). This result 
    #           will need to be multiplied by 100.0 to provide the percentage.
    #
    # Calculates % correct NOT dogs
    ...
    #           classified dog breeds. Recall that this can be calculated by 
    #           the number of correctly classified dog breeds ('n_correct_breed') 
    #           divided by the number of dog images ('n_dogs_img'). This result 
    #           will need to be multiplied by 100.0 to provide the percentage.
    #
